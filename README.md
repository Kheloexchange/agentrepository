# The Index — Top 10 Sites Directory
...
**Purely static** — `index.html`, `style.css`, `script.js`. No build step, no backend, no fetching, no API calls of any kind. Every card is a plain link out to that publication's own site.
